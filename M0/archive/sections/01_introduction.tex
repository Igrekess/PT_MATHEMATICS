...
Statut épistémique. Les sept théorèmes T0--T6 ainsi que les axiomes de pont BA0--BA5 sont, à ce jour, tous démontrés et indexés \textsc{[Thm]} dans le monographe. Le programme PT a en outre fermé en avril~2026 ses dix engagements structurels critiques (compteur \emph{C1--C10}, $10/10\;\textsc{[Thm]}$ après les promotions C2/C4/C5/C7 du 26 avril 2026)~\cite{PT_Monograph}. Cet article est autoportant : il ne suppose pas la lecture du monographe, et il forme avec son article compagnon~\cite{PT_Article2_GeoSpectral} un duo cité-couplé.
