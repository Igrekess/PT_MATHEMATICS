...
\label{eq:c1}
\end{equation}
% ERRATUM E-PM-8 (2026-08-15) : qualification du SECOND énoncé. Il était donné
% sans marque de conditionnalité dans un environnement « théorème », alors que
% le théorème berry_3pi de la monographie (app. P, sec:appP_C6_promotion) porte
% [COND]. Aucun contenu mathématique n'est modifié.
L'holonomie du revêtement $N_{\mathrm{gen}}$-fois est
$\exp(2\pi i\,c_1\,N_{\mathrm{gen}}) = \exp(3\pi i)$ (origine du
théorème \texttt{berry\_3pi} de la monographie, app.~P, \S~C7) --- ce
second énoncé est \textbf{[COND]} : il suppose $N_{\mathrm{gen}} = 3$
comme prémisse explicite du modèle, que le théorème de comptage des
couleurs n'établit pas, et le théorème \texttt{berry\_3pi} de la
monographie est lui-même \textbf{[COND]}. Seul $c_1 = 1/2$ ci-dessus
est inconditionnel.
\end{theoreme}
