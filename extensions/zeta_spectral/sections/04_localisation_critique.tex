...
$1/\sqrt{p} = e^{-u/2}$ devant la transformée (avec $u = \log p$, on a
$1/p = e^{-u}$ et $1/\sqrt{p} = e^{-u/2}$~; c'est bien la racine, celle
de la densité de Haar, qui apparaît). Plus précisément, le pôle de la
