...
% ERRATUM E-PM-8 (2026-08-15) : source précisée. Le [Thm] porte sur la SEULE
% moitié algébrique $c_1 = 1/2$ de thm:berry_3pi ; la moitié holonomie
% ($\exp(3\pi i)$) de ce même théorème est [COND] (voir \S 5). Statut inchangé.
$c_1 = 1/2$ sur fibré spinoriel $\qplus/\qminus$ & \textbf{[Thm]} & thm.~\ref{thm:berry_3pi} (moitié algébrique)\\
